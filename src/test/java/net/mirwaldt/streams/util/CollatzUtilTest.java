...
public class CollatzUtilTest {
    @Test
    void test_collatz() {
        assertEquals(0, CollatzUtil.follow(1));
        assertEquals(1, CollatzUtil.follow(2));
        assertEquals(2, CollatzUtil.follow(4));

        // 5, 3*5+1=16, 16/2=8, 8/2=4, 4/2=2, 2/2=1
        assertEquals(5, CollatzUtil.follow(5));

        // 6, 6/2=3, 3*3+1=10, 10/2=5, CollatzUtil.follow(5)
        assertEquals(8, CollatzUtil.follow(6));

        // 7*3+1=22, 22/2=11, 3*11+1=34, 34/2=17, 17*3+1=52, 52/2=26, 26/2=13,
        // 13*3+1=40. 40/2=20, 20/2=10, 10/2=5, CollatzUtil.follow(5)
        assertEquals(16, CollatzUtil.follow(7));
    }
}
