...
public class ParallelStream_12_KaratsubaInBigInteger {
    private static AtomicLong leftCounter = new AtomicLong();
    private static AtomicLong rightCounter = new AtomicLong();
    private static AtomicLong bothCounter = new AtomicLong();


    private static AtomicLong leftCounter2 = new AtomicLong();
    private static AtomicLong rightCounter2 = new AtomicLong();
    private static AtomicLong bothCounter2 = new AtomicLong();
    ...
    private static BigInteger multiplyAndWatch(BigInteger left, BigInteger right) {
